...
The data being evaluated is a [cryptocurrency dataset](https://github.com/crtallent/Cryptocurrencies/blob/main/Resources/crypto_data.csv) from CryptoCompare. 
